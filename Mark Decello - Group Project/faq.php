  ...
  <body>
    ...
    <div class="content"style="width:80%">
      ...
      <div class="para" style="width:100%">
        <p>Hello there! You have entered the FAQs page, where users will find answers to most of their
        questions. If you cannot find your question here, please email us at uhm@gmail.com. Thanks for
        visiting UHM.</p>
      </div>
      <table style="display:block">
        <tr>
          <th style="color:black">What does UHM stand for?</th>
          <td>UHM stands for U Help Me.</td>
        </tr>
        <tr>
          <th style="color:black">What is the main purpose of this website?</th>
          <td>The main purpose of the website is to help students.</td>
        </tr>
        <tr>
          <th style="color:black">Who are the creators of the website?</th>
          <td>There are 3 creators that worked on the website. They are Mark Decello, Emmanuel Aguiles, and Czerinton Kunaraja.</td>
        </tr>
        <tr>
          <th style="color:black">What year was the website created?</th>
          <td>The Website is created on 2019.</td>
        </tr>
      </table>
    </div>
